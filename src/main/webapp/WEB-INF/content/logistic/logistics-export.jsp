 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.deliverOrder.cdlCode" value="${vo.deliverOrder.cdlCode}"/>
     ...
     <input type="hidden"  name="vo.product.stockCde" value="${vo.product.stockCde}"/>
      ...
      <input type="hidden"  name="vo.approveState" value="${vo.approveState}"/>
	   ...
	   <h5><span id="formTitle">导物流费用信息</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${logisticsHeader}" var="hl">
