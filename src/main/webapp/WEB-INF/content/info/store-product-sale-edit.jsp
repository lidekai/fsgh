...
$(document).ready(function(){
	...
	$("#cancelBtn").click(function(){
	  /* var url="<c:url value='/info/store-product-sale/list.jhtml'/>";
	 ...
	 <input type="hidden" name="key" value="${key }" />
       ...
       <div class="control-group">
		...
		<div class="control-group">
	        ...
	        <div class="controls"><input name="vo.saleCount" value="${vo.saleCount}" type="text" id="count"
	        	placeholder="请输入数量"  msg="请输入数字" dataType="Double" onchange="countMoney()"/></div>
        </div>  
        
        <div class="control-group">
	        <label class="control-label">标准价销售额</label>
	        <div class="controls"><input name="vo.standardSaleMoney" value="${vo.standardSaleMoney}" type="text" id="money"
	        	placeholder="请输入数量"  msg="请输入数字" dataType="Double" /></div>
        </div> 
         <div class="control-group">
	        <label class="control-label">终端零售价销售额</label>
	        <div class="controls"><input name="vo.retailSaleMoney" value="${vo.retailSaleMoney}" type="text" id="money"
	        	placeholder="请输入数量"  msg="请输入数字" dataType="Double" /></div>
        </div>  

		<div class="control-group">
	        <label class="control-label">年月</label>
	        <div class="controls"><input class="input-medium Wdate" name="vo.yearMonth" value="${vo.yearMonth}" 
