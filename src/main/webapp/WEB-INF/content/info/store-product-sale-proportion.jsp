...
$(document).ready(function(){
	...
	$("#expBtn").click(function(){
		...
		var url="<c:url value='/info/store-product-sale/exportProportion.jhtml'/>";
 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12" style="min-width:1000px;">
     <form name="form1" action="proportion.jhtml" class="form-inline" method="post" id="form1">
      <h5><span>门店销售占比表</span></h5>
      <ul class="row-fluid"> 
      	<div class="span10">
 	       <li>
 	        <li><label>所属大区：</label>
	 	...
	 	<table class="fancyTable" id="result" cellpadding="0" cellspacing="0">
	         	<thead>
	   				<tr>
	   					...
	   					<th style="vertical-align:middle;min-width: 80px;">产品销售数量</th>
	   					<th style="vertical-align:middle;min-width: 80px;">门店销售数量</th>
	   					<th style="vertical-align:middle;min-width: 80px;">销售数量占比</th>
	   					<th style="vertical-align:middle;min-width: 80px;">产品销售额</th>
	   					<th style="vertical-align:middle;min-width: 80px;">门店销售额</th>
	   					<th style="vertical-align:middle;min-width: 80px;">销售额占比</th>
	   				</tr>
	   			</thead>
	   			<tbody>
	   				 <c:forEach items="${reslutList}" var="object" varStatus="s">
	   				 	<tr>
	   				 		...
	   				 		<td>${object[8]}</td>
	   				 		<td>${object[10]}</td>
	   				 		<td><fmt:formatNumber value="${object[8] == 0 ? '0' : (object[8])/object[10]*100}" pattern="#.##"/>%</td>
	   				 		<td>${object[9]}</td>
	   				 		<td>${object[11]}</td>
	   				 		<td><fmt:formatNumber value="${object[9] == 0 ? '0' : (object[9])/object[11]*100}" pattern="#.##"/>%</td>
	   				 	</tr>
	   				</c:forEach>
	   			</tbody>
	         </table>
