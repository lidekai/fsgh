...
$(document).ready(function(){
	...
	$("#cancelBtn").click(function(){
	  var url="<c:url value='/info/area/list.jhtml'/>";
			...
			<div class="row-fluid">
				<div class="span12">
					<form name="form1" action="update.jhtml" class="form-horizontal"
						...
						<h5>
							<span id="formTitle">编辑地区</span>
						</h5>

						<c:if test="${vo.parentArea != null}">

							<div class="control-group">
								<label class="control-label">所属分类</label>
								<div class="controls">
									<input type="hidden" name="vo.parentArea.id"
										value="${vo.parentArea.id}" /> <input type="text"
										value="${vo.parentArea.areaName}" readonly="readonly" />
								</div>
							</div>
						</c:if>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input name="vo.areaName" id="vo_name" value="${vo.areaName }"
									type="text" maxLength="125" placeholder="请输入地区名称"
									dataType="Require" msg="请输入分类名称" /><span>*</span>
							</div>
						</div>
