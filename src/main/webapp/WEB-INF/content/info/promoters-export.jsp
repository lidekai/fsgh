 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.promotersName" value="${vo.promotersName}"/>
     <input type="hidden"  name="vo.custom.customName" value="${vo.custom.customName}"/>
     <input type="hidden"  name="vo.IDCare" value="${vo.IDCare}"/>
    
  
	   <h5><span id="formTitle">导出促销员信息表</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${promotersHeader}" var="hl">
