			...
			<div class="row-fluid">
				<div class="span12">
					<form name="form1" action="update.jhtml" class="form-horizontal"
						...
						<h5>
							<span id="formTitle">编辑客户分类</span>
						</h5>

						<c:if test="${vo.parents != null}">

							<div class="control-group">
								<label class="control-label">所属分类</label>
								<div class="controls">
									<input type="hidden" name="vo.parents.id"
										value="${vo.parents.id}" /> <input type="text"
										value="${vo.parents.customTypeName}" readonly="readonly" />
								</div>
							</div>
						</c:if>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input name="vo.customTypeName" id="vo_name"
									value="${vo.customTypeName }" type="text" maxLength="125"
