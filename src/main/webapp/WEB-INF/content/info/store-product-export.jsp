 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.store.custom.customName" value="${vo.store.custom.customName}"/>
     <input type="hidden"  name="vo.store.storeName" value="${vo.store.storeName}"/>
     <input type="hidden"  name="vo.product.productName" value="${vo.product.productName}"/>
     <input type="hidden"  name="vo.product.number" value="${vo.product.number}"/>
     <input type="hidden"  name="vo.product.stockCde" value="${vo.product.stockCde}"/>
     
    
 	 
    
    
	   <h5><span id="formTitle">导出门店存货表</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${storeProductHeader}" var="hl">
