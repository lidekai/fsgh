 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.customCde" value="${vo.customCde}"/>
     <input type="hidden"  name="vo.state" value="${vo.state }"/>
     <c:if test="${roleName != '业务员' && roleName != '大区经理' && roleName != '地区经理' }">
     <input type="hidden"  name="vo.area.parentArea.id" value="${vo.area.parentArea.id }"/>
     ...
     <input type="hidden"  name="vo.user.id" value="${vo.user.id}"/>
	   ...
	   <h5><span id="formTitle">导出客户信息表</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${customHeader}" var="hl">
