...
<title>门店存货信息导入</title>
<script type="text/javascript">
$(document).ready(function(){
	$("span").first().html("门店存货信息导入");
	//确定按钮事件
	...
	$("#cancelBtn").click(function(){
	  var url="<c:url value='/info/store-product/list.jhtml'/>";
  ...
  <div class="row-fluid">
   <div class="span12">
       ...
       <div class="control-group">
        ...
        <div class="controls">
         	<a href="<c:url value='/resources/exceltemplate/storeProducttemplate.xls'/>">下载模板</a>
        </div>
       </div>
