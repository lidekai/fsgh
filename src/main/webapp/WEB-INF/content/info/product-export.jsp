 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.stockCde" value="${vo.stockCde}"/>
     <input type="hidden"  name="vo.productCde" value="${vo.productCde }"/>
     <input type="hidden"  name="vo.number" value="${vo.number }"/>
     <input type="hidden"  name="vo.productType.id" value="${vo.productType.id }"/>
     <input type="hidden"  name="vo.chargeType" value="${vo.chargeType }"/>
     <input type="hidden"  name="vo.newProduct" value="${vo.newProduct }"/>
  
 	 
    
    
	   <h5><span id="formTitle">导出产品信息表</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${productHeader}" var="hl">
