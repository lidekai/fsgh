...
<div class="jt-container" style="max-width:900px;">
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     <form name="form1" action="doExportProportion.jhtml" class="form-horizontal" method="post">
     ...
     <input type="hidden"  name="vo.productName" value="${vo.productName}"/>
      ...
      <input type="hidden"  name="vo.endMonth" value="${vo.endMonth}"/>
	   <h5><span id="formTitle">导出门店销售占比表</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${proportionHeader}" var="hl">
