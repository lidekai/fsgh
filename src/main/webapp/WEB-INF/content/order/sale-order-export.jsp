 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.csoCode" value="${vo.csoCode}"/>
     <input type="hidden"  name="vo.customName" value="${vo.customName}"/>
     <input type="hidden"  name="vo.productName" value="${vo.productName }"/>
     <input type="hidden"  name="vo.orderDateStart" value="${vo.orderDateStart}"/>
      <input type="hidden"  name="vo.orderDateEnd" value="${vo.orderDateEnd}"/>
    
	   <h5><span id="formTitle">导出销售订单表</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${saleOrderHeader}" var="hl">
