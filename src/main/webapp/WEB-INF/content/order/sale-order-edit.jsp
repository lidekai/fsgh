						...
						<div class="row-fluid">
							<div class="span6">
								<div class="control-group">
									...
									<div class="controls">
										<input name="vo.customCde" value="${vo.csoCode}" type="text" />
									</div>
								</div>
							</div>
							<div class="span6">
						...
						<div class="row-fluid">
							...
							<div class="span6">
								<div class="control-group">
									...
									<div class="controls">
										<input name="vo.LocalPrice"
											value="<fmt:formatNumber value='${vo.localPrice}' pattern='#.##'/>"
											type="text" />
									</div>
								</div>
							</div>
						...
						<div class="row-fluid">
							<div class="span6">
								<div class="control-group">
									...
									<div class="controls">
										<input name="vo.countPrice"
											value="<fmt:formatNumber value='${vo.countPrice}' pattern='#.##'/>"
											type="text" />
									</div>
								</div>
							</div>
