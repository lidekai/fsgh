 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.cdlCode" value="${vo.csoCode}"/>
     ...
     <input type="hidden"  name="vo.isRebate" value="${vo.isRebate}"/>
     <input type="hidden"  name="vo.saleTypeCode" value="${vo.saleTypeCode}"/>
     	
	   <h5><span id="formTitle">导出发货订单表</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${deliverOrderHeader}" var="hl">
