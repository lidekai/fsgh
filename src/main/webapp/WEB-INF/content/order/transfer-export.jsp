 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.transCode" value="${vo.transCode}"/>
     <input type="hidden"  name="vo.stockName" value="${vo.stockName}"/>
     <input type="hidden"  name="vo.inWhouseName" value="${vo.inWhouseName }"/>
     <input type="hidden"  name="vo.outWhouseName" value="${vo.outWhouseName }"/>
     <input type="hidden"  name="vo.transBeginTime" value="${vo.transBeginTime}"/>
     <input type="hidden"  name="vo.transEndTime" value="${vo.transEndTime}"/>
    
    	
	   <h5><span id="formTitle">导出仓库调拨单</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${transferHeader}" var="hl">
