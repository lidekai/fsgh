...
<div class="jt-container" style="max-width:900px;">
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     <form name="form1" action="doExportStat.jhtml" class="form-horizontal" method="post">
     ...
     <input type="hidden"  name="vo.beginTime" value="${vo.beginTime}"/>
      ...
      <input type="hidden"  name="vo.statTime" value="${vo.statTime}"/>
    
	   <h5><span id="formTitle">导出账期统计表</span></h5>
		<div class="row-fluid">
   			<div class="span12">
   			<div class="control-group">
   			 <label class="control-label">表头信息</label>
      		<div class="controls">
      			<c:forEach items="${statAccountHeader}" var="hl">
