 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.cvouchId" value="${vo.cvouchId}"/>
     <input type="hidden"  name="vo.customerName" value="${vo.customerName}"/>
     <input type="hidden"  name="vo.beginTime" value="${vo.beginTime}"/>
      ...
      <input type="hidden"  name="vo.state" value="${vo.state}"/>
	   ...
	   <h5><span id="formTitle">导出待核单</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${receiptBillHeader}" var="hl">
