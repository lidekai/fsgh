 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.csbvcode" value="${vo.csbvcode}"/>
     ...
     <input type="hidden"  name="vo.beginTime" value="${vo.beginTime}"/>
      <input type="hidden"  name="vo.endTime" value="${vo.endTime}"/>
       <input type="hidden"  name="vo.areaName" value="${vo.areaName}"/>
      <input type="hidden"  name="act" value="${act}"/>
    
	   <h5><span id="formTitle">导出${not empty act ? '待核单明细余额表': '应收单'}</span></h5>
		<div class="row-fluid">
   			<div class="span12">
   			<div class="control-group">
   			 <label class="control-label">表头信息</label>
      		<div class="controls">
      			<c:forEach items="${receiveBillHeader}" var="hl">
