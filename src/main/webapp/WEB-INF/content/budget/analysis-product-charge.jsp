...
$(document).ready(function(){
	...
	$("#expBtn").click(function(){
		...
		var url="<c:url value='/budget/analysis/exportProCharge.jhtml'/>";
		url+="?vo.custom.customName=" + cusName +"&vo.storeName=" + storeName + "&vo.custom.area.parentArea.id="+ pareaId + "&vo.custom.area.id=" + areaId;
		url+="&vo.product.productName=" + proName +"&vo.product.stockCde="+ stockCde + "&vo.project.id="  + projectId +   "&vo.dateStart="+ dateStart+ "&vo.dateEnd="+ dateEnd;
 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12" style="min-width:1000px;">
     <form name="form1" action="productCharge.jhtml" class="form-inline" method="post" id="form1">
      <h5><span>产品核销明细表</span></h5>
      <ul class="row-fluid"> 
      	<div class="span10">
      		 <li>
 	        	<label>所属大区：</label>
	 	...
	 	<table class="fancyTable" id="result" cellpadding="0" cellspacing="0">
         	<thead>
   				<tr>
   					...
   					<th style="vertical-align:middle;min-width: 50px;">日期</th>
   					<th style="vertical-align:middle;min-width: 30px;">类型</th>
   					<th style="vertical-align:middle;min-width: 30px;">编号</th>
   			...
   			<tbody>
				<c:forEach items="${verList}" var="object" varStatus="s">
						<tr>
						<td style="vertical-align:middle;">${object[0]}</td>
						<td style="vertical-align:middle;">${object[1]}</td>
						<td style="vertical-align:middle;">${object[2]}</td>
						<td style="vertical-align:middle;">${object[12]}</td>
