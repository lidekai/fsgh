 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.feeName" value="${vo.feeName}"/>
     <input type="hidden"  name="vo.projectType" value="${vo.projectType}"/>
	   ...
	   <h5><span id="formTitle">导出合同外预提</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${provisionProjectHeader}" var="hl">
