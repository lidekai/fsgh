 ...
 <div class="container-fluid">
  <div class="row-fluid">
   <div class="span12">
     ...
     <input type="hidden"  name="vo.provisionCode" value="${vo.provisionCode}"/>
     <input type="hidden"  name="vo.custom.customName" value="${vo.custom.customName}"/>
     <input type="hidden"  name="vo.provisionProject.feeName" value="${vo.provisionProject.feeName}"/>
     <input type="hidden"  name="vo.provisionProject.projectType" value="${vo.provisionProject.projectType}"/>
     ...
     <input type="hidden"  name="vo.endDate" value="${vo.endDate}"/>
	   ...
	   <h5><span id="formTitle">导出合同外预提</span></h5>
		...
		<div class="row-fluid">
      		...
      		<div class="controls">
      			<c:forEach items="${outFeeProvisionHeader}" var="hl">
