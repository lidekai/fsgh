...
<title>门店销售预提信息导入</title>
<script type="text/javascript">
$(document).ready(function(){
	$("span").first().html("门店销售预提导入");
	//确定按钮事件
	...
	$("#cancelBtn").click(function(){
	  var url="<c:url value='/budget/store-sale-provision/list.jhtml'/>";
...
<body>
	<div class="jt-container" style="max-width: 1000px;">
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
					<form name="form1" action="doImp.jhtml" class="form-horizontal"
						...
						<div class="control-group">
							...
							<div class="controls">
								<a
									href="<c:url value='/resources/exceltemplate/storeSaleProtemplate.xls'/>">下载模板</a>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="file" id="xlsfileupload" name="xlsfileupload"
									style="height: 22px" />
								<blockquote>
									<small>说明：上传的格式必须以模板为准，所有字段均为文本格式。</small>
								</blockquote>
							</div>
						</div>
