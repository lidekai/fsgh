...
<body>
	<div class="jt-container" style="max-width: 900px;">
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
					<form name="form1" action="doExportDiffer.jhtml"
						...
						<h5>
							<span id="formTitle">导出预提核销余额表</span>
						</h5>
						...
						<div class="row-fluid">
							<div class="span12">
								<div class="control-group">
									...
									<div class="controls">
										<c:forEach items="${differHeader}" var="hl" varStatus="i">
											<c:if test="${i.count >0 && i.count <= 4}">
						...
						<div class="row-fluid">
							<div class="span12">
								<div class="control-group">
									...
									<div class="controls">
										<c:forEach items="${differHeader}" var="hl" varStatus="i">
											<c:if test="${i.count >4 && i.count <= 12}">
												<span class="label" att-name="${hl}">${hl}</span>
											</c:if>
										</c:forEach>
									</div>
