				...
				<div class="span12">
					<form name="form1" action="doExportProBudget.jhtml"
						...
						<input type="hidden" name="header" id="header" /> <input
							...
							<input type="hidden" name="vo.storeName"
							value="${vo.storeName }" />

						<h5>
							<span id="formTitle">导出产品费用预提明细表</span>
						</h5>
						...
						<div class="row-fluid">
							<div class="span12">
								<div class="control-group">
									...
									<div class="controls">
										<c:forEach items="${proBudHeader}" var="hl">
