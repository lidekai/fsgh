 ...
 */
@Entity
@Table(name ="charge_in_fee_verification")
public class InFeeVerification extends POSupport {
	private static final long serialVersionUID = -7286760400321678000L;
